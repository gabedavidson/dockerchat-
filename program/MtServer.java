...
public class MtServer {
  ...
  private void getConnection() {
    ...
    try {
      System.out.println("Waiting for client connections on port 9001.");
      ...
      while (true) {
        ...
        Client c = new Client(connectionSock,"Unknown");

        // Add this socket to the list
        clientList.add(c);
        // Send to ClientHandler the socket and arraylist of all sockets
        ClientHandler handler = new ClientHandler(c, this.clientList);
